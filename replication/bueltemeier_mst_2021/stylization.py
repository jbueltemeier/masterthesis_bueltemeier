...
def main(args):
    # model_name = "bueltemeier_2021__intaglio__instance_norm-563842e4.pth"
    model_name = "bueltemeier_2021__MAD_20_2005__mask__intaglio__instance_norm-82606331.pth"
    ...
    if args.masked:
        ...
        for i in range(40):
            ...
            output_name = f"intaglio_mask_{i}_{style}"
